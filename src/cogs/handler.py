        ...
        if isinstance(error, ignored):
            ...
            if cmd == "member":
                return await ctx.send(
                    specify_member + "Command usage: `n!member <member>`"
                )
            elif cmd == "say":
                return await ctx.send(
                    ":x: Type the text you want me to "
                    + "repeat.\nCommand usage: `n!say <text>`"
                )
            elif cmd == "sayto":
                return await ctx.send(
                    ":x: Specify the member and message."
                ...
                em.add_field(name="To choose Rock:", value="`n!rps R`")
                em.add_field(name="To choose Paper:", value="`n!rps P`")
                em.add_field(name="To choose Scissors:", value="`n!rps S`")
                em.set_footer(text="I choose randomly.")
                return await ctx.send(embed=em)
            elif cmd == "roast":
                return await ctx.send(
                    specify_member + "Command usage: `n!roast <member>`"
                )
            elif cmd == "annoy":
                return await ctx.send(
                    specify_member + "Command usage: `n!annoy <member> [times]`"
                )
            elif cmd == "sound":
                return await ctx.send(
                ...
                return await ctx.send(
                    specify_member + "Command usage: `n!kill <member>`"
                )
            elif cmd == "respawn":
                return await ctx.send(
                    specify_member + "Command usage: `n!respawn <member>`"
                )
            elif cmd == "disable":
                return await ctx.send(
                    specify_member + "Command usage: `n!disable <member>`"
                )
            elif cmd == "enable":
                return await ctx.send(
                    specify_member + "Command usage: `n!enable <member>`"
                )
            elif cmd == "kick":
                return await ctx.send(
                    specify_member + "Command usage: `n!kick <member> [reason]`"
                )
            elif cmd == "ban":
                return await ctx.send(
                    specify_member + "Command usage: `n!ban <member> [reason]`"
                )
            elif cmd == "unban":
                return await ctx.send(
                    ":x: Enter the ID of the user you "
                ...
                return await ctx.send(
                    specify_member + "Command usage: `n!mute <member> [duration]`"
                )
            elif cmd == "unmute":
                return await ctx.send(
                    specify_member + "Command usage: `n!unmute <member>`"
                )
            elif cmd == "chatmute":
                return await ctx.send(
                    specify_member + "Command usage: `n!chatmute <member> [duration]`"
                )
            elif cmd == "unchatmute":
                return await ctx.send(
                    specify_member + "Command usage: `n!unchatmute <member>`"
                )
            elif cmd == "ship":
                return await ctx.send(
                    ":x: Please specify both members.\n"
                    + "Command usage: `n!ship <member1> <member2>`"
                )
            elif cmd == "delete":
                return await ctx.send(
                    ":x: Enter the amount of messages "
                ...
                return await ctx.send(
                    ":x: Enter the expression you want "
                    + "me to calculate.\nCommand usage: `n!calc <expr>`\n"
                    + "Examples: `n!calc 2 + 3`, `n!calc 2 + 3 / 2`"
                )
            elif cmd == "randnum":
                return await ctx.send(
                    ":x: Enter both min and max numbers.\n"
                ...
                return await ctx.send(
                    ":x: Give me some options to randomly "
            ...
            if cmd in [
                ...
                return await ctx.send(
                    ":x:  I wasn't able to find an user "
                    + "with that ID.\nCommand usage: `n!unban <userID>`"
                ...
                return await ctx.send(
                    ":x: As the duration, enter numbers " + "only. No decimals."
                )
